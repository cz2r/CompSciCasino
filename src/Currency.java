...
public class Currency {
    ...
    private static final String[] titles = { // Titles that the player can buy
        " the Ace", 
        " the Jester", 
        " the All Knowing",  
        " the Lucky Duck",
    ...
    private static final int[] prices = {1000, 2000, 3000, 5000, 10000, 100000, 1000000}; // Prices of the titles
